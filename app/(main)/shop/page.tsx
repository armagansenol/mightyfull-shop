...
export default async function ShopPage() {
  ...
  return (
    <section className={cn(s.shop, "flex flex-col items-center")}>
      ...
      <div className="flex flex-col items-center tablet:grid grid-cols-4 gap-16 mt-20 px-4 tablet:px-0">
        {cards.map((item) => {
          return (
            <div className={cn(s.card, "flex flex-col items-center tablet:items-stretch gap-10")} key={item.id}>
