...
export type SanityCustomProductOption = SanityCustomProductOptionColor | SanityCustomProductOptionSize
...
export type SanityMenuLink = SanityCollectionGroup | SanityLinkExternal | SanityLinkInternal
...
export interface SanityModuleImageProductHotspots extends SanityModuleImageBase {
  _key?: string
  productHotspots?: SanityProductHotspot[]
