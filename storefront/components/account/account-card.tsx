...
export function AccountCard({
  ...
  return (
    <Tag
      className={cn(
        'rounded-2xl border border-blue-ruin/20 bg-sugar-milk text-blue-ruin',
        ...
        <header className="px-5 md:px-6 pt-5 md:pt-6 pb-4 flex items-center justify-between gap-4">
          ...
          >
            {icon && (
              <span
                aria-hidden="true"
                className="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-blue-ruin/25 bg-cerulean/20 text-blue-ruin"
              >
