  ...
  return (
    <>
      ...
      <section
        ...
        className="grid grid-cols-1 md:grid-cols-3 gap-3 rounded-2xl border border-blue-ruin/20 bg-cerulean/18 p-3 md:p-4"
      >
            ...
            {recentOrder ? (
              <>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="rounded-xl border border-blue-ruin/15 bg-cerulean/15 px-4 py-3">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-xl border border-blue-ruin/15 bg-cerulean/15 p-4">
            ...
            <div className="divide-y divide-blue-ruin/15">
              {QUICK_ACTIONS.map((action) => (
                <Link
                  ...
                  className="group grid grid-cols-[2.5rem_minmax(0,1fr)_auto] items-center gap-3 px-5 md:px-6 py-4 transition-colors duration-200 hover:bg-columbia-blue/25 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-ruin/60 focus-visible:ring-offset-2 focus-visible:ring-offset-sugar-milk cursor-pointer"
                >
                  <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-blue-ruin/20 bg-cerulean/20 text-blue-ruin transition-[background-color,transform] duration-200 group-hover:-translate-y-0.5 group-hover:bg-columbia-blue/35">
                    <HugeiconsIcon
                      icon={action.icon}
                      size={18}
                      strokeWidth={1.75}
