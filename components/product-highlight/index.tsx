...
export function ProductHighlight(props: ProductHighlightProps) {
  ...
  return (
    <div
      className={cn(
        s.productHighlight,
        `bg flex flex-col items-center justify-center`
      )}
      ref={scopeRef}
    >
        ...
        {props.items.map((item, i) => {
          return (
            <div
              className={cn(
                s.panel,
                `panel panel-${i} flex items-center justify-center`
              )}
              key={item._id}
              style={
                {
            ...
            >
              <div className="transform-c">
                <Link
                  className={cn(
                    s.item,
                    'rotate-c flex flex-col items-center cursor-pointer space-y-10'
                  )}
