  ...
  if (isFetching) {
    return (
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="w-full h-[250px] tablet:h-[600px] flex items-center justify-center"
      >
            ...
            <AnimatePresence mode="wait">
              {data?.reviews.length === 0 ? (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -20 }}
                  transition={{ duration: 0.3 }}
                  className="w-full h-[250px] tablet:h-[300px] flex flex-col items-center justify-center gap-10"
                >
                  ...
                  <Button
                    className="w-48 h-14 mx-auto tablet:ml-auto"
                ...
                <motion.div
                  ...
                  className="w-full min-h-[250px] tablet:min-h-[300px] flex items-center justify-center"
                >
